...
강건성: 손익분기 편도 비용 ≥ 가정 비용×2, 월수익 상위 3개월을 빼도 연샤프가 절반 이상 유지, 대표 파라미터를 ×0.5·×1.5 로
바꿔도 샤프가 양수이고 중앙값이 대표의 절반 이상.
표본 밖: 마지막 2년은 떼어 두고 파라미터는 그 앞 구간으로만 고른다. 떼어 둔 2년의 샤프가 0 이하면 탈락한다(period.start 는
충분히 앞으로 — IS 3년 + OOS 2년 이상이 되게).
