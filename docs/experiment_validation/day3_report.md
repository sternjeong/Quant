# Day 3 — 기준선과 S1~S5 전 기간 비용 후 백테스트
...
| 전략/기준선 | CAGR | 최대낙폭 | Calmar | 연 turnover |
| --- | ---: | ---: | ---: | ---: |
| S1 | 16.76% | -15.93% | 1.052 | 5.545 |
| S2 | 14.49% | -26.02% | 0.557 | 5.014 |
| S3 | 6.37% | -19.77% | 0.322 | 1.643 |
| S4 | 8.13% | -9.14% | 0.890 | 2.116 |
| S5 | 13.40% | -16.56% | 0.809 | 1.664 |
| SPY_buy_hold | 15.55% | -33.72% | 0.461 | 0.138 |
| SPY_IEF_60_40 | 9.35% | -21.24% | 0.440 | 0.353 |
| candidate_universe_equal_weight | 10.70% | -27.83% | 0.385 | 0.482 |

### proxy_17

| 전략/기준선 | CAGR | 최대낙폭 | Calmar | 연 turnover |
| --- | ---: | ---: | ---: | ---: |
| S1 | 9.38% | -21.52% | 0.436 | 5.919 |
| S2 | 9.84% | -25.92% | 0.380 | 5.867 |
| S3 | 5.80% | -19.87% | 0.292 | 1.417 |
| S4 | 4.28% | -13.28% | 0.323 | 2.002 |
| S5 | 7.08% | -25.05% | 0.283 | 2.248 |
| SPY_buy_hold | 11.73% | -51.48% | 0.228 | 0.054 |
| SPY_IEF_60_40 | 8.36% | -31.83% | 0.263 | 0.282 |
| candidate_universe_equal_weight | 8.39% | -43.51% | 0.193 | 0.399 |

### actual_5_full

| 전략/기준선 | CAGR | 최대낙폭 | Calmar | 연 turnover |
| --- | ---: | ---: | ---: | ---: |
| S4 | 5.03% | -13.28% | 0.379 | 1.959 |
| S5 | 7.99% | -25.05% | 0.319 | 2.365 |
| SPY_buy_hold | 11.08% | -55.19% | 0.201 | 0.051 |
| SPY_IEF_60_40 | 8.17% | -32.58% | 0.251 | 0.278 |
| candidate_universe_equal_weight | 6.93% | -34.76% | 0.199 | 0.378 |

## 검증 결과

관련 테스트 **63 passed**; 별도 게시 worktree에서도 **63 passed**. 실행 중 및 저장 CSV를 다시
읽은 검증 모두 **54,606개 체결 / 228,360개 순자산 행**을
실제 티커의 조정 단위 매수·매도와 현금 흐름으로 독립 재구성했다. 재구성기는 실행 엔진을 호출하지 않는다.
최대 순자산 상대오차는 **6.55e-15** (허용 오차 1e-10).
...
그 중 실제 보유한 가격 평가 기록은 비용률별 계좌를 합쳐 **39행**이며 모두 해당 날짜 체결은 없다.
...
- `baseline_metrics.csv` SHA-256: `57644d3e8fcbb4b0dda8dac10344e4f7b590f8a2d48c25df187ef72293cabcfd`.
